...
func init() {
	...
	utilruntime.Must(fintechv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1236caf4.fintech.io",
	...
	if err := (&controller.ReconciliationJobReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "reconciliationjob")
		os.Exit(1)
	}
